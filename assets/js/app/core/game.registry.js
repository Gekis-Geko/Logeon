(function (window) {
    ...
    function resolveFactory(factoryName) {
        var key = String(factoryName || '').trim();
        if (!key) {
    ...
    window.GameRegistry.getPageModules = getPageModules;
    window.GameRegistry.resolveFactory = resolveFactory;
    window.GameRegistry.registerModules = registerModules;
})(window);
