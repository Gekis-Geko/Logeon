        ...
        for (var ai = 0; ai < availabilitySelectors.length; ai++) {
            if (document.querySelector(availabilitySelectors[ai])) {
                availabilityGroups.push(RadioGroup(availabilitySelectors[ai], {
                    btnClass: 'btn-sm d-flex justify-content-start align-items-center',
                    groupClass: 'w-100',
                    vertical: true,
                    options: [
                        { label: '<i class="bi bi-dot fs-3 text-success"></i> Disponibile', value: '1', style: 'secondary', html: true },
                        { label: '<i class="bi bi-dot fs-3 text-danger"></i> Occupato', value: '0', style: 'secondary', html: true },
                        { label: '<i class="bi bi-dot fs-3 text-warning"></i> Non al PC', value: '2', style: 'secondary', html: true },
                        { label: '<i class="bi bi-dot fs-3 text-info"></i> Ricerca di gioco', value: '3', style: 'secondary', html: true }
                    ],
