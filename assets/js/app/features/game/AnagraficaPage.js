(function (window) {
    ...
    function GameAnagraficaPage(extension) {
        var page = {
            ...
            init: function () {
                ...
                if (!this.root || typeof window.Paginator !== 'function') {
                    return this;
                }
                ...
                var paginator = new window.Paginator();
    ...
    window.GameAnagraficaPage = GameAnagraficaPage;

    function autoInit() {
        if (window[AUTO_INIT_FLAG] === true) {
            return;
        }
        if (!document.getElementById('anagrafica-page')) {
            return;
        }
        window[AUTO_INIT_FLAG] = true;
        window.Anagrafica = window.GameAnagraficaPage({});
    }
