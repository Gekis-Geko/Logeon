(function (window) {
    ...
    function GameLocationInvitesPage(extension) {
            let page = {
                ...
                showNext: function () {
                    ...
                    window.locationInviteModal.show({
                ...
                accept: function () {
                    ...
                    var onSuccess = function (response) {
                        if (window.locationInviteModal && typeof window.locationInviteModal.hide === 'function') {
                            window.locationInviteModal.hide();
                        }
    ...
    window.GameLocationInvitesPage = GameLocationInvitesPage;
})(window);
