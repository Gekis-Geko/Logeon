...
function GameLocationWhispersPage(extension) {
    var page = {
        ...
        setUnreadBadge: function (value) {
            ...
            if (unread > 0 && globalWindow.AppSounds && typeof globalWindow.AppSounds.play === 'function') {
                globalWindow.AppSounds.play('whispers');
            }
...
globalWindow.GameLocationWhispersPage = GameLocationWhispersPage;
export { GameLocationWhispersPage as GameLocationWhispersPage };
export default GameLocationWhispersPage;
