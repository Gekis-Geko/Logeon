    ...
    var NotificationsPage = {
        ...
        initTabControl: function () {
            ...
            if (typeof window.RadioGroup === 'function') {
                ...
                this.tabControl = window.RadioGroup('#notifications-tab-filter', {
        ...
        apiPost: function (url, data, successFn, errorFn) {
            ...
            var facade = window.AppFacade && typeof window.AppFacade.http === 'function'
                ? window.AppFacade.http()
                : null;
        ...
        updateNavBadge: function (count) {
            ...
            if (show && window.AppSounds && typeof window.AppSounds.play === 'function') {
                window.AppSounds.play('notifications');
            }
        },
        ...
        handleActionError: function (err, fallbackMessage) {
            ...
            if (window.AppFacade && typeof window.AppFacade.toast === 'function') {
                window.AppFacade.toast(msg, 'error');
            }
        },
        ...
        respond: function (notificationId, decision) {
            ...
            this.apiPost('/notifications/respond', { notification_id: notificationId, decision: decision }, function (res) {
                ...
                if (typeof window.AppFacade !== 'undefined' && window.AppFacade.toast) {
                    window.AppFacade.toast(msg, 'error');
                }
            });
        },
