(function (window) {
            ...
            let page = {
                ...
                bindThreadButtons: function () {
                    ...
                    block.on('click', '[data-action="thread-edit"]', function (e) {
                        e.preventDefault();
                        if (typeof window.editThreadModal !== 'undefined' && window.editThreadModal && typeof window.editThreadModal.show === 'function') {
                            window.editThreadModal.show(self.dataset);
                        }
                    });
                ...
                _doMoveThread: function () {
                    ...
                    var onSuccess = function () {
                        ...
                        setTimeout(function () {
                            window.location.href = '/game/forum/' + forumId + '/thread/' + self.thread_id + '/';
                        }, 1200);
                    };
                    var onError = function (error) {
                        if (typeof Toast !== 'undefined') {
    ...
    window.GameThreadPage = GameThreadPage;
})(window);
