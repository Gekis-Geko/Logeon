...
function openComposeModal(characterId, characterName) {
    var openModal = null;
    if (globalWindow.GameMessagesModal && typeof globalWindow.GameMessagesModal.openMessageModal === 'function') {
        openModal = globalWindow.GameMessagesModal.openMessageModal;
    } else if (typeof globalWindow.GameOpenMessageModal === 'function') {
        openModal = globalWindow.GameOpenMessageModal;
    }
...
function GameOnlinesPage(extension, mode) {
        let base = {
            ...
            syncAutoToastConfig: function () {
                ...
                if (typeof globalWindow.APP_CONFIG !== 'undefined') {
                    this.showAutoToast = (parseInt(globalWindow.APP_CONFIG.onlines_auto_toast, 10) === 1);
                    return this.showAutoToast;
                }
            ...
            _syncAvailabilityControl: function () {
                let controls = [];
                if (typeof globalWindow.AvailabilityControl !== 'undefined') {
                    controls.push(globalWindow.AvailabilityControl);
                }
                if (typeof globalWindow.AvailabilityNavControl !== 'undefined') {
                    controls.push(globalWindow.AvailabilityNavControl);
                }
                if (!controls.length) {
                    return;
                }
                ...
                if (typeof globalWindow.updateAvailabilityIndicator === 'function') {
                    globalWindow.updateAvailabilityIndicator(availability);
                }
            },
...
globalWindow.GameOnlinesPage = GameOnlinesPage;
export { GameOnlinesPage as GameOnlinesPage };
export default GameOnlinesPage;
