...
var AdminNarrativeEvents = {
    ...
    showModal: function (id) {
        ...
        if (globalWindow.bootstrap && globalWindow.bootstrap.Modal) {
            globalWindow.bootstrap.Modal.getOrCreateInstance(modalNode).show();
            return;
        }
        if (typeof $ === 'function') {
    ...
    hideModal: function (id) {
        ...
        if (globalWindow.bootstrap && globalWindow.bootstrap.Modal) {
            globalWindow.bootstrap.Modal.getOrCreateInstance(modalNode).hide();
            return;
        }
        if (typeof $ === 'function') {
...
globalWindow.AdminNarrativeEvents = AdminNarrativeEvents;
export { AdminNarrativeEvents as AdminNarrativeEvents };
export default AdminNarrativeEvents;
