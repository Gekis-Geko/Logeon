...
var AdminConflicts = {
    ...
    initSwitches: function () {
        if (typeof globalWindow.SwitchGroup !== 'function') return;
    ...
    mountSwitch: function (selector, options) {
        ...
        if (!node) return null;
        this.switches[selector] = globalWindow.SwitchGroup(node, Object.assign({ showLabels: true }, options || {}));
    ...
    searchFilterLocations: function () {
        ...
        if (this.filterLocationTimer) {
            globalWindow.clearTimeout(this.filterLocationTimer);
        ...
        this.filterLocationTimer = globalWindow.setTimeout(function () {
    ...
    searchOpenLocations: function () {
        ...
        if (this.openLocationTimer) {
            globalWindow.clearTimeout(this.openLocationTimer);
        ...
        this.openLocationTimer = globalWindow.setTimeout(function () {
            self.searchLocations(query, function (rows) {
    ...
    searchRollTargets: function () {
        ...
        if (this.rollTargetTimer) {
            globalWindow.clearTimeout(this.rollTargetTimer);
        ...
        this.rollTargetTimer = globalWindow.setTimeout(function () {
    ...
    searchOverrideActors: function () {
        ...
        if (this.overrideActorTimer) {
            globalWindow.clearTimeout(this.overrideActorTimer);
        ...
        this.overrideActorTimer = globalWindow.setTimeout(function () {
    ...
    err: function (error) {
        var code = '';
        var message = '';
        if (globalWindow.Request && typeof globalWindow.Request.getErrorCode === 'function') code = String(globalWindow.Request.getErrorCode(error, '') || '').trim();
        if (globalWindow.Request && typeof globalWindow.Request.getErrorMessage === 'function') message = String(globalWindow.Request.getErrorMessage(error, '') || '').trim();
        var map = {
...
globalWindow.AdminConflicts = AdminConflicts;
export { AdminConflicts as AdminConflicts };
