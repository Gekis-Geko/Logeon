(function () {
    ...
    var AdminCharacterLifecycle = {
        ...
        handleTransitionCharacterInput: function () {
            ...
            if (this.transitionSearchTimer) {
                window.clearTimeout(this.transitionSearchTimer);
            ...
            this.transitionSearchTimer = window.setTimeout(function () {
    ...
    window.AdminCharacterLifecycle = AdminCharacterLifecycle;
})();
