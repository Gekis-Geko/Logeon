(function () {
    ...
    var AdminItemEquipmentRules = {
        ...
        initGrid: function () {
            ...
            this.grid = new Datagrid('grid-admin-item-equipment-rules', {
                ...
                orderable: true,
                thead: true,
                handler: { url: '/admin/item-equipment-rules/list', action: 'list' },
        ...
        loadDependencies: function (done) {
            ...
            this.post('/admin/equipment-slots/list', { query: {}, page: 1, results: 200, orderBy: 'sort_order|ASC' }, function (response) {
        ...
        save: function () {
            ...
            var url = isNew ? '/admin/item-equipment-rules/create' : '/admin/item-equipment-rules/update';
            var self = this;
        ...
        remove: function () {
            ...
            var self = this;
            this.post('/admin/item-equipment-rules/delete', { id: payload.id }, function () {
                self.modal.hide();
    ...
    window.AdminItemEquipmentRules = AdminItemEquipmentRules;
})();
