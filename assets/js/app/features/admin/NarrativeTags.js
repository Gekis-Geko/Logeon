(function () {
    ...
    var AdminNarrativeTags = {
        ...
        initModalSwitch: function () {
            ...
            if (!this.switches.is_active) {
                this.switches.is_active = window.SwitchGroup(
                    window.$('#admin-narrative-tags-form [name="is_active"]'),
                ...
                http.post(url, payload)
                    ...
                    .catch(function (err) {
                        var msg = window.Request && typeof window.Request.getErrorMessage === 'function'
                            ? window.Request.getErrorMessage(err)
    ...
    window.AdminNarrativeTags = AdminNarrativeTags;
})();
