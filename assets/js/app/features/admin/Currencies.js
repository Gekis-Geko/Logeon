(function () {
    ...
    var AdminCurrencies = {
        ...
        initGrid: function () {
            ...
            this.grid = new Datagrid('grid-admin-currencies', {
                ...
                orderable: true,
                thead: true,
                handler: { url: '/admin/currencies/list', action: 'list' },
        ...
        save: function () {
            ...
            var self = this;
            var url = payload.id > 0 ? '/admin/currencies/update' : '/admin/currencies/create';
            ...
            Dialog('warning', {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: function () {
                            self.post('/admin/currencies/delete', { id: id }, function () {
    ...
    if (typeof window !== 'undefined') {
        window.AdminCurrencies = AdminCurrencies;
    }
})();
