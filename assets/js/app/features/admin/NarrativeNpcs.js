...
var AdminNarrativeNpcs = {
    ...
    loadFactions: function () {
        ...
        this.post(factionsListEndpoint, { page: 1, results: 500, orderBy: 'name|ASC', query: {} }, function (res) {
    ...
    post: function (url, payload, ok, fail) {
        var self = this;
        if (typeof globalWindow.Request !== 'undefined' && globalWindow.Request && globalWindow.Request.http
    ...
    err: function (e) {
        if (typeof globalWindow.Request !== 'undefined' && globalWindow.Request
            ...
            var m = String(globalWindow.Request.getErrorMessage(e, '') || '').trim();
            if (m) { return m; }
        }
...
globalWindow.AdminNarrativeNpcs = AdminNarrativeNpcs;
export { AdminNarrativeNpcs as AdminNarrativeNpcs };
export default AdminNarrativeNpcs;
