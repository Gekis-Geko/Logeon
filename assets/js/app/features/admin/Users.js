...
var AdminUsers = {
    ...
    setPermissionInputValue: function (input, value) {
        ...
        if (typeof globalWindow.$ === 'function') {
            globalWindow.$(input).trigger('change');
        }
    ...
    initPermissionsHierarchySwitches: function (form, options) {
        ...
        if (typeof globalWindow.SwitchGroup === 'function') {
            ...
            moderatorSwitch = globalWindow.SwitchGroup(moderatorInput, {
                preset: 'activeInactive',
                trueLabel: 'Attivo',
                falseLabel: 'Disattivo',
                trueValue: '1',
            ...
            masterSwitch = globalWindow.SwitchGroup(masterInput, {
                preset: 'activeInactive',
                trueLabel: 'Attivo',
                falseLabel: 'Disattivo',
                trueValue: '1',
    ...
    requestErrorMessage: function (error) {
        if (typeof window !== 'undefined' && globalWindow.Request && typeof globalWindow.Request.getErrorMessage === 'function') {
    ...
    requestUnavailableMessage: function () {
        if (typeof window !== 'undefined' && globalWindow.Request && typeof globalWindow.Request.getUnavailableMessage === 'function') {
            return globalWindow.Request.getUnavailableMessage();
        }
    ...
    getConfirmDialog: function () {
        if (globalWindow.SystemDialogs && typeof globalWindow.SystemDialogs.ensureGeneralConfirm === 'function') {
            return globalWindow.SystemDialogs.ensureGeneralConfirm();
        }
        if (globalWindow.generalConfirm && typeof globalWindow.generalConfirm.show === 'function') {
            return globalWindow.generalConfirm;
        }
        return null;
    },
...
globalWindow.AdminUsers = AdminUsers;
export { AdminUsers as AdminUsers };
