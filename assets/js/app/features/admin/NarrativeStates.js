(function () {
    ...
    var AdminNarrativeStates = {
        ...
        initSwitches: function () {
            ...
            if (this.includeInactive) {
                this.includeInactiveSwitch = window.SwitchGroup(this.includeInactive, {
                    trueValue: '0',
                    falseValue: '1',
                    defaultValue: '0',
            ...
            if (this.form && this.form.elements && this.form.elements.is_active) {
                this.formSwitches.is_active = window.SwitchGroup(this.form.elements.is_active, {
                    trueValue: '1',
                    falseValue: '0',
                    defaultValue: '1',
                    trueLabel: 'Attivo',
            ...
            if (this.form && this.form.elements && this.form.elements.visible_to_players) {
                this.formSwitches.visible_to_players = window.SwitchGroup(this.form.elements.visible_to_players, {
                    trueValue: '1',
                    falseValue: '0',
                    defaultValue: '1',
                    trueLabel: 'Visibile',
        ...
        debounce: function (key, delayMs, fn) {
            ...
            this.debounceTimers[id] = window.setTimeout(function () {
                fn();
    ...
    window.AdminNarrativeStates = AdminNarrativeStates;
})();
