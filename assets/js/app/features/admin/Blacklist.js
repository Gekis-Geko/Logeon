...
var AdminBlacklist = {
    ...
    initSwitches: function () {
        ...
        if (!input || typeof globalWindow.SwitchGroup !== 'function') {
            return this;
        }
        this.onlyActiveSwitch = globalWindow.SwitchGroup(input, {
            preset: 'yesNo',
            trueLabel: 'Si',
            falseLabel: 'No',
            trueValue: '1',
    ...
    scheduleUserSearch: function (query) {
        ...
        if (this.userSearchTimer) {
            globalWindow.clearTimeout(this.userSearchTimer);
        ...
        this.userSearchTimer = globalWindow.setTimeout(function () {
...
globalWindow.AdminBlacklist = AdminBlacklist;
export { AdminBlacklist as AdminBlacklist };
