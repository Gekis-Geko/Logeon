(function () {
    ...
    var AdminEquipmentSlots = {
        ...
        initGrid: function () {
            ...
            this.grid = new Datagrid('grid-admin-equipment-slots', {
                ...
                orderable: true,
                thead: true,
                handler: { url: '/admin/equipment-slots/list', action: 'list' },
        ...
        save: function () {
            ...
            var url = isNew ? '/admin/equipment-slots/create' : '/admin/equipment-slots/update';
            var self = this;
        ...
        remove: function () {
            ...
            var self = this;
            this.post('/admin/equipment-slots/delete', { id: payload.id }, function (response) {
                self.modal.hide();
    ...
    window.AdminEquipmentSlots = AdminEquipmentSlots;
})();
