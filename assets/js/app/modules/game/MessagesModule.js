    ...
    return {
        ...
        widget: function (extension) {
            if (typeof globalWindow.GameMessagesPage === 'function') {
                try {
                    return globalWindow.GameMessagesPage(extension || {});
                } catch (error) {}
            }
...
globalWindow.GameMessagesModuleFactory = createMessagesModule;
export { createMessagesModule as GameMessagesModuleFactory };
export default createMessagesModule;
