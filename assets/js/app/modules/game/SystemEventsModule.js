(function (window) {
    ...
    function createSystemEventsModule() {
        return {
            ...
            mount: function (ctx, options) {
                ...
                if (typeof window.GameSystemEventsPage === 'function') {
                    this.page = window.GameSystemEventsPage({ moduleApi: this });
                }
                return this;
            },
    ...
    window.SystemEventsModuleFactory = createSystemEventsModule;
})(window);
