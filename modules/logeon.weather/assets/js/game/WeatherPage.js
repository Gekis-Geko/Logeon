(function (window) {
    ...
    function ensureWeatherNavbarPopover() {
        ...
        $(document).off('click.weather-navbar-popover').on('click.weather-navbar-popover', function (event) {
            if (!$(event.target).closest('#weatherNavbarPopoverBtn, .popover').length) {
